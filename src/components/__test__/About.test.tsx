...
describe('About Component', () => {
  ...
  it('renders the welcome message', () => {
    ...
    const welcomeMessage = screen.getByText(
      /Welcome to Shop, your number one source for all grocery needs./i,
    );
  ...
  it('renders the founding story', () => {
    ...
    const foundingStory = screen.getByText(
      /Founded in 2020, Shop has come a long way from its beginnings in a small town./i,
    );
  ...
  it('renders the sustainability commitment', () => {
    ...
    const sustainabilityCommitment = screen.getByText(
      /At Shop, we are committed to sustainability and ethical sourcing./i,
    );
  ...
  it('renders the thank you message', () => {
    ...
    const thankYouMessage = screen.getByText(
      /Thank you for choosing Shop. We appreciate your business and look forward to serving you for many years to come./i,
    );
